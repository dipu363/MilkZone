...
// here handel user already login
    ...
    private void saveToken(String token) {
        ...
        Current_User current_user = new Current_User(email, token);

        DatabaseReference databaseReference = FirebaseDatabase.getInstance().getReference("current_user");
        databaseReference.child(mAuth.getCurrentUser().getUid()).setValue(current_user).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
